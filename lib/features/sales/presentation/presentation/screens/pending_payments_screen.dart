// lib/features/sales/presentation/presentation/screens/pending_payments_screen.dart
...
class _PendingPaymentsScreenState extends State<PendingPaymentsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<PaymentProvider>().loadPendingPayments();
    });
  }
    ...
    return Scaffold(
      ...
      body: Consumer<PaymentProvider>(
        builder: (context, provider, _) {
          ...
          if (provider.errorMessage != null && provider.pendingPayments.isEmpty) {
            ...
            return const Center(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 16),
                  Text('Bekleyen ödeme bulunmuyor.', style: TextStyle(fontSize: 18)),
                ],
              ),
            );
          }
          ...
          return RefreshIndicator(
            onRefresh: () => provider.loadPendingPayments(),
